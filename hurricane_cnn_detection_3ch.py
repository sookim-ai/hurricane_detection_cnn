...
# Read Data
path="/export/kim79/h2/finished_npy/7/hurricane_crop_hr3ch/"
...
for i in range(channels):
    #(1) First Convolutional Layer
     W_conv1[i] = weight_variable([5, 5, 1, 32])
    ...
    #(2) Second Convolutional Layer
     W_conv2[i] = weight_variable([7, 7, 32, 64])
...
#     W_conv3[i] = weight_variable([3, 3, 64, 128])
...
#(5) Readout Layer
W_fc2 = weight_variable([128, label_size]) 
