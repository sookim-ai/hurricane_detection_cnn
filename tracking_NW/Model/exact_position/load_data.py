...
def load_data(path):
    ...
    #Change as output locations
    tr_lonlat_out=tr_output_lonlat[:,:,1:d3,:]
    va_lonlat_out=va_output_lonlat[:,:,1:d3,:]
    return d1,d2,d3,d4,d5,t1,t2,t3,t4,t5,timesteps,train_size,val_size,channels,tr_image,va_image,tr_state_in,va_state_in,tr_lonlat_in,va_lonlat_in,tr_lonlat_out,va_lonlat_out
